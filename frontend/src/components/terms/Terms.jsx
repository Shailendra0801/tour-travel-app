...
export default function Terms() {
  return (
    <div className='FLEX flex-col'>
        <div className="text-4xl h-48 flex items-end justify-center mb-6">
        ...
        <div className='w-11/12'>
            ...
            <div>
                <h1>1.Booking and Reservations</h1>
                <ul>
            ...
            <div>
                <h1>5. Customer Responsibilities</h1>
                <ul>
            ...
            <div>
                <h1>11. Amendments to Terms and Condition</h1>
                <ul>
